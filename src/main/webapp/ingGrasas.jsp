...
<body>
    <h2>Seleccionar Ingredientes - Grasas</h2>
    <form action="<%= request.getContextPath() %>/guardarIngredientes" method="post">
        ...
        <input type="hidden" name="comidaCena" value="<%= request.getParameter("comidaCena") %>">
         ...
         <!-- Cuando el usuario hace clic en "Guardar", el formulario envía los ingredientes seleccionados al servlet GuardarIngredientesServlet. -->
