<%@page contentType="text/html" pageEncoding="UTF-8" import="java.util.Optional, jakarta.servlet.http.Cookie, jakarta.servlet.http.HttpServletRequest, java.util.Arrays"%>
<!DOCTYPE html>
<html>
<head>
    <meta charset="UTF-8">
...
<body>
   <%
	...
	%>
        ...
        <a class="boton" href="<%= request.getContextPath() %>/calendario.jsp">Crear nuevo calendario</a>
