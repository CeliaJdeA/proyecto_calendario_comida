...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="${pageContext.request.contextPath}/css/formNutrientes.css">
</head>
<body>
    <h2>Seleccionar Ingredientes - Vegetales</h2>
    <form action="<%= request.getContextPath() %>/guardarIngredientes" method="post">
        ...
        <table>
            ...
            <tbody> <!-- Itera sobre la lista de ingredientes (ingConNut) pasada desde el servlet ClasificaciónNutrientes. -->
                <% for (Ingrediente ingrediente : (List<Ingrediente>) request.getAttribute("ingConNut")) { %>
                    <tr>
                        <td> <!-- Cada ingrediente se representa como un checkbox en un formulario. El valor de cada checkbox es el ID del ingrediente. -->
        ...
        </table> <!-- Cuando el usuario hace clic en "Guardar", el formulario envía los ingredientes seleccionados al servlet GuardarIngredientesServlet. -->
